...
return array (
    ...
    'top' => array (
				...
				1 => array('name' => 'a-men-1', 'ico' => 'icon-cog', 'url' => url('admin/index/config'),   'select' => '101', 'option' => array('index-config', 'user-index','auth-index','index-log','index-attack', 'ip-index', 'site-config', 'site-index')),
				2 => array('name' => 'a-men-2', 'ico' => 'icon-table', 'url' => url('admin/category/index'), 'select' => '201', 'option' => array('category-index', 'model-index', 'attachment-index', 'position-index', 'content-index', 'relatedlink-index', 'block-index', 'linkage-index', 'form-index')),
