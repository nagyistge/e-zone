 ...
 */
	...
	$file1 = FCPATH.'controllers/'.$RTR->fetch_directory().ucfirst($RTR->fetch_class()).'.php';
	$file2 = FCPATH.'controllers/'.$RTR->fetch_directory().ucfirst($RTR->fetch_class()).'Controller.php';
